...
String urlgetuser = "http://expectojr.com/mygardener/php/get_user.php";
String urluploadImage = "http://expectojr.com/mygardener/php/upload_imageprofile.php";
String urlupdate = "http://expectojr.com/mygardener/php/update_profile.php";
File _image;
int number = 0;
String _value;
