...
class _TabScreen2State extends State<TabScreen2> {
  ...
  Future<String> makeRequest() async {
    String urlLoadJobs = "http://expectojr.com/mygardener/php/load_job_user.php";
  ...
  Future init() async {
    if (widget.user.email=="user@noregister"){
      Toast.show("Please register to view posted gardener service", context,
  ...
  void requestNewJob() {
    ...
    if (widget.user.email != "user@noregister") {
      ...
      Toast.show("Please register first to request new gardener service", context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      Navigator.push(
          context,
          MaterialPageRoute(
  ...
  Future<String> deleteRequest(String jobid) async {
    String urlLoadJobs = "http://expectojr.com/mygardener/php/delete_job.php";
    ProgressDialog pr = new ProgressDialog(context,
        type: ProgressDialogType.Normal, isDismissible: false);
